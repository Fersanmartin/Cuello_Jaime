...
class Master():
    ...
    #         posx=int(data.data[0])
    #         posy=int(data.data[1])

    #         v_motores= matriz[posx,posy]
    #         print(v_motores)
            
    #         if type(v_motores) != int:
    #             if v_motores[2]<-27000:
    #                 v_motores[2]=-27000
                
    #             angulos=[v_motores[2],v_motores[3],v_motores[4]]
    #             goal_position(1, int(v_motores[2]+offset[0]),modo=1,vel=200)
    #             goal_position(2, int(v_motores[3]+offset[1]),modo=1,vel=200)
    #             goal_position(3,angulos[2]*1023/299,modo=1,vel=200)
